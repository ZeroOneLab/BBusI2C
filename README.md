# BBusI2C
![License](https://img.shields.io/badge/License-MIT-blue.svg)  ![Language](https://img.shields.io/badge/Language-C-brightgreen.svg) ![Platform](https://img.shields.io/badge/Platform-Embedded%20MCU-orange.svg)

**BBusI2C** 是一款 **高通用性、分层解耦**的软件I2C驱动框架，专为嵌入式MCU设计，解决硬件I2C资源不足、传统软件I2C代码冗余、跨平台移植困难等问题，支持多路总线并行、独立速度配置，适配STM32等主流MCU平台。
...
#define I2C_LUN        0 //表示aht30在0号iic总线上
